...
import { Instagram, Twitter, Linkedin, Youtube, Hexagon, ArrowUpRight } from 'lucide-react';
      ...
      <div className="max-w-7xl mx-auto px-6 grid grid-cols-1 md:grid-cols-4 gap-12">
        <div className="col-span-1 md:col-span-1">
          <Link to="/" className="flex items-center space-x-2 mb-6">
            <Hexagon size={28} className="text-amber-500" />
        ...
        <div>
          ...
          <form className="relative">
            ...
            />
            <button className="absolute right-1 top-1 bottom-1 bg-amber-500 text-black rounded-full px-4 group">
